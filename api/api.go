...
func (api *API) Update(cfg *config.Config, route *dispatch.Route, setAlertStatus func(model.LabelSet)) {
	api.v1.Update(cfg, route)
	api.v2.Update(cfg, route, setAlertStatus)
}
